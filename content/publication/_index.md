...
- **Wang, T.**, Qu, Y., Zilinskas, R. and Li, Y. (2022+). Win ratio: from estimands to estimation. *In preparation*. 
...
- **Wang, T.** and Mao, L. (2021). Stratified proportional win-fractions regression analysis. *In preparation*. <i class="fab fa-r-project"></i>[Code](https://cran.r-project.org/web/packages/WR/index.html)

- Mao, L. and **Wang, T.** (2020). A Class of Proportional Win-Fractions Regression Models for Composite Outcomes. [*Biometrics*](https://onlinelibrary.wiley.com/doi/10.1111/biom.13382), 10.1111/biom.13382. <i class="fab fa-r-project"></i>[Code](https://cran.r-project.org/web/packages/WR/index.html)
